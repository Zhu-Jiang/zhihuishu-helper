// ==UserScript==
// @name         智慧树讨论区自动发帖助手 (DeepSeek)
// @namespace    http://tampermonkey.net/
// @version      33.0
// @description  自动在智慧树讨论区发提问/发回答，内容由 DeepSeek 生成。使用前需自填 API Key。
// @author       Assistant
// @match        *://*.zhihuishu.com/*
...
(function() {
    ...
    function createControlPanel() {
        ...
        panel.innerHTML = `
            <div style="font-weight: bold; font-size: 16px; border-bottom: 1px solid #555; padding-bottom: 5px;">🤖 讨论区助手 (DeepSeek)</div>
...
5. 只返回问题本身，不要包含任何引号或前缀。`;
    ...
    window.addEventListener('load', function() {
        createControlPanel();
        showToast('✅ 讨论区助手就绪 (DeepSeek)', false);
