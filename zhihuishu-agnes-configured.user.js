// ==UserScript==
// @name         智慧树讨论区自动发帖助手 (Agnes 已配置)
// @namespace    http://tampermonkey.net/
// @version      33.0
// @description  自动在智慧树讨论区发提问/发回答，内容由 Agnes 3.0 Flash 生成。
// @author       Assistant
// @match        *://*.zhihuishu.com/*
...
(function() {
    ...
    // ================= 配置区域 =================
    const API_KEY = 'sk-gq9ATYexUkoj00fHc7aWiIrNZcoHAXGaVP8cSkVL79Xpk2PH';
    ...
    function fetchAIAnswer(question) {
        return new Promise((resolve, reject) => {
            if (!API_KEY || API_KEY.indexOf('sk-xxx') !== -1) { reject('请先填写 API Key！'); return; }
